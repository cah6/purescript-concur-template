          ...
          var merge = function (dictMonoid1) {
              return function (ws) {
                  return function (wscs) {
                      var wsm = Data_Functor.map(Data_Array_NonEmpty_Internal.functorNonEmptyArray)(function ($93) {
                          return Control_Monad_Free.wrap(WidgetStep(Data_Either.Right.create($93)));
                      })(ws);
                      ...
                      if (v instanceof Data_Either.Right) {
                          if (v.value0 instanceof Data_Either.Left) {
                              return Control_Monad_Free.wrap(WidgetStep(new Data_Either.Left(function __do() {
                                  var v1 = v.value0.value0();
                                  return combineInner1(dictMonoid1)(ws)(Data_Array_NonEmpty["cons'"](v1)(x.tail));
                              })));
                          };
              ...
              return function (wfs) {
                  ...
                  if (v instanceof Data_Either.Right) {
                      if (v.value0 instanceof Data_Either.Left) {
                          return Control_Monad_Free.wrap(WidgetStep(new Data_Either.Left(function __do() {
                              var v1 = v.value0.value0();
                              return combine(dictMonoid1)(Data_Array_NonEmpty["cons'"](v1)(x.tail));
                          })));
                      };
                      if (v.value0 instanceof Data_Either.Right) {
          ...
          if (v instanceof Data_Either.Right) {
              if (v.value0 instanceof Data_Either.Left) {
                  return Control_Monad_Free.wrap(Concur_Core_Types.WidgetStep(new Data_Either.Left(function __do() {
                      var v1 = v.value0.value0();
                      return mkNodeWidget$prime(mkView)(v1);
                  })));
              };
              if (v.value0 instanceof Data_Either.Right) {
                  return Control_Monad_Free.wrap(Concur_Core_Types.WidgetStep(new Data_Either.Left(function __do() {
                      var v1 = Effect_AVar.empty();
                      var eventHandler = function (a) {
                          return Data_Functor["void"](Effect.functorEffect)(Effect_AVar.tryPut(Control_Applicative.pure(Control_Monad_Free.freeApplicative)(a))(v1));
                      };
                      var cont$prime = Control_Parallel_Class.sequential(Effect_Aff.parallelAff)(Control_Alt.alt(Effect_Aff.altParAff)(Control_Parallel_Class.parallel(Effect_Aff.parallelAff)(Effect_Aff_Class.liftAff(Effect_Aff_Class.monadAffAff)(Effect_Aff_AVar.take(v1))))(Control_Parallel_Class.parallel(Effect_Aff.parallelAff)(Data_Functor.map(Effect_Aff.functorAff)(mkNodeWidget$prime(mkView))(v.value0.value0.cont))));
      ...
      return function (w) {
          ...
          if (v instanceof Data_Either.Left) {
              if (v.value0 instanceof Data_Either.Left) {
                  return function __do() {
                      var v1 = v.value0.value0();
                      return dischargePartialEffect(dictMonoid)(v1)();
                  };
              };
              if (v.value0 instanceof Data_Either.Right) {
          ...
          return function (v) {
              ...
              if (v1 instanceof Data_Either.Left) {
                  if (v1.value0 instanceof Data_Either.Left) {
                      return function __do() {
                          var v2 = v1.value0.value0();
                          return discharge(dictMonoid)(handler)(v2)();
                      };
                  };
                  if (v1.value0 instanceof Data_Either.Right) {
                      return function __do() {
                          Effect_Aff.runAff_((function () {
                              var $23 = Data_Functor.map(Data_Either.functorEither)(Concur_Core_Types.Widget);
                              return function ($24) {
                                  return handler($23($24));
                              };
  ...
  var componentClass = function (winit) {
      ...
      var handler = function (v) {
          return function (v1) {
              ...
              throw new Error("Failed pattern match at Concur.React (line 31, column 3 - line 33, column 50): " + [ v.constructor.name, v1.constructor.name ]);
          };
      };
...
(function($PS) {
  ...
  var Data_Functor = $PS["Data.Functor"];
  var Data_Monoid = $PS["Data.Monoid"];                
  var hello = Control_Bind.discard(Control_Bind.discardUnit)(Concur_Core_Types.widgetBind)(Data_Functor["void"](Concur_Core_Types.widgetFunctor)(Concur_React_DOM.button(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_React_Props.onClick ])([ Concur_React_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("Say Hello") ])))(function () {
      return Concur_React_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("Hello Sailor!");
  });
  var main = Concur_React_Run.runWidgetInDom("root")(hello);
  exports["hello"] = hello;
  exports["main"] = main;
})(PS);
PS["Main"].main();